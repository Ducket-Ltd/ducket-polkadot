...
const MOCK_EVENTS = [
  {
    ...
    tiers: [
      { name: "Gallery Entry", seatPrefix: "GA-", price: "0.25", maxSupply: 150 },
      { name: "Collector's Preview", seatPrefix: "CP-", price: "0.75", maxSupply: 50 },
    ],
  },
  {
    ...
    transferEnabled: true,
    tiers: [
      { name: "Attendee Pass", seatPrefix: "ATT-", price: "0.4", maxSupply: 400 },
      { name: "Investor Circle", seatPrefix: "INV-", price: "1.5", maxSupply: 100 },
    ],
  },
  {
    ...
    transferEnabled: true,
    tiers: [
      { name: "General Admission", seatPrefix: "GA-", price: "0.5", maxSupply: 100 },
      { name: "VIP Pass", seatPrefix: "VIP-", price: "2.0", maxSupply: 20 },
    ],
  },
  {
    ...
    transferEnabled: true,
    tiers: [
      { name: "Standard Entry", seatPrefix: "STD-", price: "0.8", maxSupply: 700 },
      { name: "Premium VIP", seatPrefix: "PVIP-", price: "2.0", maxSupply: 200 },
    ],
  },
  {
    ...
    tiers: [
      { name: "Gamer Pass", seatPrefix: "GP-", price: "0.3", maxSupply: 300 },
      { name: "Pro Gamer VIP", seatPrefix: "PGV-", price: "1.0", maxSupply: 100 },
    ],
  },
  {
    ...
    transferEnabled: true,
    tiers: [
      { name: "General Seating", seatPrefix: "GEN-", price: "0.2", maxSupply: 200 },
      { name: "Front Row", seatPrefix: "FR-", price: "0.5", maxSupply: 50 },
    ],
  },
];
...
async function main() {
  ...
  console.log("Deploying DucketTickets to Polkadot Hub TestNet...");
  console.log("=".repeat(60));
  ...
  console.log("\n✅ DucketTickets deployed successfully!");
  ...
  for (let i = 0; i < MOCK_EVENTS.length; i++) {
    ...
    for (let j = 0; j < event.tiers.length; j++) {
      ...
      console.log(`   🎫 Tier ${j + 1}: ${tier.name} (Token ID: ${tokenIdCounter}, Price: ${tier.price} DOT, Supply: ${tier.maxSupply})`);
      tokenIdCounter++;
    }
  }
  ...
  console.log("\n📋 Next steps:");
  console.log("1. Update frontend .env with CONTRACT_ADDRESS=" + contractAddress);
  console.log("2. Deploy frontend to Vercel");
  console.log("3. Run: npm run set-metadata -- " + contractAddress);
  console.log("\n" + "=".repeat(60));
}
